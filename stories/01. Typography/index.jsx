...
stories.add(
  ...
  rel="stylesheet">
    ...
    () => (
      <div>
        <H1 mb="0">Montserrat (headings)</H1>
        <H1 my="0" small fontWeight="thin">
          {' '}
          thin: 300
        </H1>
        <H1 mt="0" small fontWeight="regular">
          {' '}
          regular: 400
        </H1>
        <H1 mb="0" mt="10" fontFamily="body">
          Open Sans (body)
        </H1>
        <H1 my="0" small fontWeight="thin" fontFamily="body">
          {' '}
          regular: 400
        </H1>
        <H1 my="0" small fontWeight="normal" fontFamily="body">
          {' '}
          normal: 500
        </H1>
        <H1 mt="0" small fontWeight="bold" fontFamily="body">
          {' '}
          bold: 700
        </H1>
      </div>
